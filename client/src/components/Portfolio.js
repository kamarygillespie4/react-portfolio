    ...
    >
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            ...
            work day. The page displays the current date and time. The page has
            several blocks of time in which the user can input their events for
            the day. The event blocks are color coordinated based on whether or
            not that time of day has passed.
          </p>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            ...
            This is a command-line application that accepts user input. Once the
            user fills in all of their teams information. The application
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            ...
            has a title and body to be filled in by the user. In order to access
            a previously made note, simply click on its title in the column on
            the left.
          </p>
          <div className="d-grid gap-2">
            <Button
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Movie Picker</h3>
          <p>
            The purpose of this site is to show the user 6 random movies, based
            on the genre they've selected. This application utilizes a movie
            database API in order to return 6 movies based on the category
